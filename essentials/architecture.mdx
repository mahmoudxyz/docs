...
description: "PlatyMap uses a multi-layered architecture, we will go over the big picture and discuss used design patterns."
---
...
1. User creates a mapping using the DSL
